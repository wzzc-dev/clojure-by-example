(ns wang.zhichuang.humble.app.examples.svg
  (:require
...
(defn svg [width height xpos ypos scale]
  (ui/clip
    (ui/rect (paint/fill 0xFF90DC48)
      (ui/width width
        (ui/height height
          (ui/svg {:xpos xpos :ypos ypos :scale scale} "src/wang/zhichuang/humble/app/images/ratio.svg"))))))
        ...
        (ui/column
          ...
          (ui/clip
            (ui/rect (paint/fill 0xFF90DC48)
              (ui/width (* 44 step)
                (ui/height (* 7 step)
                  (ui/svg {:preserve-aspect-ratio false} "src/wang/zhichuang/humble/app/images/ratio.svg"))))))))))
