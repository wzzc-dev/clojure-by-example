(ns wang.zhichuang.humble.app.examples.todomvc
  (:require
          ...
          (ui/width 40
            (ui/height 40
              (ui/dynamic _ [state (completed-all?)]
                (if state
                  (ui/svg "src/wang/zhichuang/humble/app/images/todomvc/uncheck-all.svg")
                  (ui/svg "src/wang/zhichuang/humble/app/images/todomvc/check-all.svg"))))))))))
      ...
      (ui/width 40
        (ui/height 40
          (ui/dynamic _ [state @*state]
            (if state
              (ui/svg "src/wang/zhichuang/humble/app/images/todomvc/checked.svg")
              (ui/svg "src/wang/zhichuang/humble/app/images/todomvc/unchecked.svg"))))))))
          ...
          (ui/clickable
            ...
            (ui/width 40
              (ui/height 40
                (ui/dynamic ctx [{:hui/keys [hovered?]} ctx]
                  (if hovered?
                    (ui/svg "src/wang/zhichuang/humble/app/images/todomvc/delete-hovered.svg")
                    (ui/svg "src/wang/zhichuang/humble/app/images/todomvc/delete.svg")))))))
        (ui/gap 40 40)))))
