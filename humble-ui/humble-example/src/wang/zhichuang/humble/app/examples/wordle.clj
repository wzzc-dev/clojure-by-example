(ns wang.zhichuang.humble.app.examples.wordle
...
(def dictionary
  (->> (slurp "src/wang/zhichuang/humble/app/examples/wordle_dictionary.txt")
    (str/split-lines)
    (map str/upper-case)
    (set)))

(def solutions
  (->> (slurp "src/wang/zhichuang/humble/app/examples/wordle_solutions.txt")
    (str/split-lines)
    (mapv str/upper-case)))
